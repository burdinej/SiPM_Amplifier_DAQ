...
public:
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "SiPM Power Supply Control", 0));
        setVolt->setText(QApplication::translate("MainWindow", "Set Voltage", 0));
        monChan->setText(QApplication::translate("MainWindow", "Monitor Channel", 0));
        measVolt->setText(QString());
        label->setText(QApplication::translate("MainWindow", "Board #", 0));
        label_2->setText(QApplication::translate("MainWindow", "Channel #", 0));
        label_3->setText(QApplication::translate("MainWindow", "Desired Voltage", 0));
        label_4->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt;\">V</span></p></body></html>", 0));
        label_5->setText(QApplication::translate("MainWindow", "Monitored / Measured Values", 0));
        label_6->setText(QApplication::translate("MainWindow", "SiPM Voltage (volts)", 0));
        label_7->setText(QApplication::translate("MainWindow", "SiPM Current (amps)", 0));
    } // retranslateUi
